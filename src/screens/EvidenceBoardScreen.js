...
const styles = StyleSheet.create({
  ...
  boardAmbientGlow: { ...StyleSheet.absoluteFill, backgroundColor: "rgba(255, 216, 142, 0.35)" },
  boardNoise: { ...StyleSheet.absoluteFill, opacity: 0.15 },
  ...
  celebrationBlocker: { ...StyleSheet.absoluteFill, zIndex: 900, backgroundColor: "transparent" },
  tutorialHand: {
    position: "absolute",
    top: 0,
    left: "50%",
