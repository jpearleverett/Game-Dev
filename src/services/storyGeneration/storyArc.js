...
function _createStoryArc(superPathKey, choiceHistory) {
  ...
  return {
    ...
    chapterArcs: [
      ...
      { chapter: 10, phase: getPhase(10), beatType: getBeatType(10), primaryFocus: 'The mechanism behind the anchors', tensionLevel: 9, endingHook: 'The pattern names what has been mapping him', personalStakes: `What ${protagonist.fullName} is willing to break`, emotionalAnchor: 'Accepting that rules can be weaponized' },
